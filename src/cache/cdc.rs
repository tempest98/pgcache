...
impl CdcProcessor {
    ...
    async fn provision_replication(settings: &Settings) -> Result<(), CacheError> {
    ...
    pub async fn new(
        ...
        // Provision publication and slot before starting replication
        Self::provision_replication(settings).await?;
